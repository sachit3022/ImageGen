...
class ScoreBasedModelling:
    ...
    def diffuse_samples(self, u0):
        ...
        l_t = self.one_minus_alpha_t_bar[t_index] #(1 - torch.exp(-2*t_list))/2 #l_t = torch.ones_like(t_list) # self.one_minus_alpha_t_bar[t_index] #self.one_minus_alpha_t_bar[t_index] #
